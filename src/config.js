const users = () => {
  ...
  return [
    ...
    return {
      ...
      downVoteComments: [],
      commentCount: 0,
      createTime: now + Math.floor(Math.random() * 1e5),
...
module.exports = {
  ...
  comment: {
    ...
    articleId: '0001',
    userId: '0002',
    content: '写里好啊~~写里生动，还形象，中中中，真不赖',
    createTime: 1533047813074,
    isDeleted: false,
    commentId: null,
  },
  schema: {
    user: {
      ...
      validator: {
        $jsonSchema: {
          bsonType: 'object',
          required: ['id', 'name', 'gender', 'upVoteArticles', 'downVoteArticles', 'upVoteComments', 'downVoteComments', 'commentCount', 'isDeleted'],
          properties: {
            id: {
              bsonType: 'string',
              description: 'user id'
    ...
    article: {
      ...
      validator: {
        $jsonSchema: {
          bsonType: 'object',
          required: ['id', 'createTime', 'title', 'content', 'author', 'upVoteCount', 'downVoteCount', 'commentCount', 'isDeleted'],
          properties: {
            id: {
              bsonType: 'string',
              description: 'article id'
    ...
    comment: {
      ...
      validator: {
        $jsonSchema: {
          bsonType: 'object',
          required: ['createTime', 'content', 'userId', 'articleId', 'id', 'isDeleted'],
          properties: {
            id: {
              bsonType: 'string',
              description: 'comment id',
            ...
            articleId: {
              bsonType: 'string',
              description: 'comment article id',
            },
            commentId: {
              bsonType: 'string',
              description: 'comment to comment to id, optional',
            },
            isDeleted: {
              bsonType: 'boolean',
